            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Transaksiku</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="{{ URL::to('') }}"><i
                                                class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active">Transaksiku
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <section id="description" class="card">
                    <div class="card-header">
                        <h4 class="card-title">Transaksiku</h4>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a href="javascript:void(0)"
                                                                            ...
                                                                            onclick="detailUnpaid('{{ Crypt::encrypt($item->id) }}')">
                                                                            Check</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="javascript:void(0)" class="btn btn-sm btn-info"
                                                                        onclick="detailPaid('{{ Crypt::encrypt($item->id) }}')">
                                                                        Check</a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                            ...
                                                            @foreach ($valid as $item)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a href="javascript:void(0)"
                                                                            class="btn btn-sm btn-info"
                                                                            onclick="detailValid('{{ Crypt::encrypt($item->id) }}')">
                                                                            Check</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
